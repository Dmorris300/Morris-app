...
const PLAN_META = {
  ...
  enterprise: { name: "Enterprise", price: "£299+", period: "per month", desc: "Unlimited users + white-label.", icon: Building2, features: ["Unlimited users", "White label available", "Priority support"], contact: true },
};
