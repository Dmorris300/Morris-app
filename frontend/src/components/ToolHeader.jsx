...
export function ResultActions({ title, content, toolId, photo, photoCaption, photos, liveSignature, clientSignature }) {
  ...
  const onPdf = () => downloadPdf({ title, content, user: effectiveUser, photo, photoCaption, photos, clientSignature });
  const onEmail = () => {
  ...
  const onWhatsAppPdf = () => {
    downloadPdf({ title, content, user: effectiveUser, photo, photoCaption, photos, clientSignature });
    setTimeout(() => {
