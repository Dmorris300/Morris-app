...
import { Info, Star, Save, Copy, Download, Mail, MessageCircle, MessageSquare, Loader2, HardHat } from "lucide-react";
...
export function ResultActions({ title, content, toolId }) {
  ...
  const onSms = () => {
    // Native SMS app — body only (recipient picked in their address book)
    const body = encodeURIComponent(`${title}\n\n${content}\n\nGenerated by Morris (morrisapp.co.uk)`);
    // iOS uses & after the recipient, Android uses ?body= with no recipient — both formats work in practice
