...
export function ResultActions({ title, content, toolId, photo, photoCaption, liveSignature, clientSignature }) {
  ...
  const onPdf = () => downloadPdf({ title, content, user: effectiveUser, photo, photoCaption, clientSignature });
  const onEmail = () => {
  ...
  const onWhatsAppPdf = () => {
    downloadPdf({ title, content, user: effectiveUser, photo, photoCaption, clientSignature });
    setTimeout(() => {
