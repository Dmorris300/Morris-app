...
import { emojiFor, disclaimerFor } from "../lib/tools-config";
    ...
    <>
      ...
      >
        <p style={{ fontSize: 10, color: "#666666", lineHeight: 1.5, margin: 0 }}>
          This document was generated by Morris for administrative assistance only. Always review before use. Morris Construction Tech Ltd accepts no liability for any loss, damage or injury arising from reliance on this document.
        </p>
      </div>
    </>
  );
