...
| **Site Diary** (`site-diary`) | ❌ None | — | ❌ Only via `GenericToolPage` | — | 🔴 Outstanding | Basic AI-generated diary from prompt template only | Full dedicated page with time-stamped entries, weather auto-fill, crew log, photo attach, print-ready A4 layout |
